...
parser.add_argument('--nact', type=int, required=False, help='nact', default=3)
...
betas = [0.5,args.balpha, args.bsigma]
gamma = args.gamma

savevar = False
savefig = False
exptname = f'1D_td_{nact}a_{npc}n_{seed}s_{train_episodes}e_{goalsize}gs_{actor_eta}plr_{pc_eta}llr_{constant_eta}alr_{sigma_eta}slr_{args.balpha}ba_{args.bsigma}bs'
figdir = './fig/'
datadir = './data/'
